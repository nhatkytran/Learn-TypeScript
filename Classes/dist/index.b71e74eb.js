...
})({"i2mg7":[function(require,module,exports) {
...
// Using an Accessor - Getter Method
{
    class Person {
        ...
        get age() {
            if (this._age === undefined) throw new Error("The age property has not been set yet!");
            return this._age;
        }
    }
    const ajaxander = new Person("Ajaxander");
    ajaxander.age = 21;
...
}// Refactoring the Constructor Method
{
    ...
    const ajaxander = new Person("Ajaxander", 21);
}{
    class Person {
...
},{}]},["i2mg7","h7u1C"], "h7u1C", "parcelRequirebbb5")
