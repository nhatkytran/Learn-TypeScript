...
// +++ Using Multiple Types as Generics +++
{
    ...
    let Brands1;
    (function(Brands1) {
        Brands1["ferrari"] = "ferrari";
        Brands1["honda"] = "honda";
        Brands1["bmw"] = "bmw";
        Brands1["toyota"] = "toyota";
    })(Brands1 || (Brands1 = {}));
    let Colors1;
    (function(Colors1) {
        Colors1["red"] = "red";
...
// Interfaces are just binding contracts and not concrete implementations
{
    ...
    const ferrari = new Car(Brands.ferrari, [
        Colors.red
    ], "A horse!");
    const truck = new Truck(Brands.toyota, [
        Colors.black
    ], "A truck!");
}// -----------------------------------------------------------------
...
},{}]},["3LmCz","h7u1C"], "h7u1C", "parcelRequireb647")
