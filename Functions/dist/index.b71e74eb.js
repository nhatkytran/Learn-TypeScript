...
},{}],"h7u1C":[function(require,module,exports) {
{
    ...
    const intro3 = (name, age)=>`My name is ${name} and age is ${age}`;
}{
    function intro(name, age, country) {
        if (country) return `My name is ${name} and age is ${age}. I live in ${country}`;
        return `My name is ${name} and age is ${age}`;
    }
}{
    let AgeUnit;
    ...
    function converAgeToMonths(person) {
        return {
            ...person,
            age: 252,
...
},{}]},["3LmCz","h7u1C"], "h7u1C", "parcelRequiref384")
