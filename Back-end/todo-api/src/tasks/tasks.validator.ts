...
export const createValidator: ValidationChain[] = [
  body('title')
    ...
    .trim()
    .isString()
    .withMessage('Title needs to be in the text format!'),
  body('date')
    .not()
    .isEmpty()
    .withMessage('The task date ismandatory!')
    .isString()
    .withMessage('The date needs to be in the valid format!'),
  body('description')
    .trim()
    .isString()
    .withMessage('Description needs to be in the valid format!'),
  body('priority')
    .trim()
